...
# Calculate the 50th percentile of Sample.Measurement for each Date and Hour
...
write.csv(all_clean, file = "~/CO_CRA/CO_CRA/Output/hourly_ozone_VOCs.csv")
```
...
#format data to calculate acute HQs and HIs
```{r}
...
#save percentiles df for QC
write.csv(percentiles_df, file = "~/CO_CRA/CO_CRA/Output/final_hourly_50.csv")
```
