---
title: "Acute HI calculations for 95th percentile values"
author: "Paige Varner"
date: "2024-06-10"
...
#calculate 95th percentile of ozone mean within specified dates/times
```{r}
...
percentiles_df <- merged_df %>%
  ...
  summarise(ozone = quantile(Sample.Measurement, 0.95, na.rm = TRUE))
...
acute_rfcs$Chemical = gsub("Trichloroethylene (TCE)", "C2HCl3", acute_rfcs$Chemical, fixed = TRUE)
acute_rfcs$Chemical = gsub("Tetrachloroethylene (PCE)", "C2Cl4", acute_rfcs$Chemical, fixed = TRUE)
acute_rfcs$Chemical = gsub("Aliphatic low", "Aliphatic_low", acute_rfcs$Chemical)
acute_rfcs$Chemical = gsub("Aromatic medium", "Aromatic_medium", acute_rfcs$Chemical)
...
#calculate 95th percentile concentrations for sites/phase
...
#save
write.csv(percentiles_df, file = "~/CO_CRA/CO_CRA/Output/acute_concs_95.csv")
...
#save percentiles df for QC
write.csv(percentiles_df, file = "~/CO_CRA/CO_CRA/Output/final_hourly_95.csv")
...
#save data
write.csv(acute_HIs, file = "~/CO_CRA/CO_CRA/Output/acute_HIs_95.csv")
write.csv(perc_rfcs, file = "~/CO_CRA/CO_CRA/Output/acute_HQs_95.csv")
...
#save data
write.csv(acute_HIs_VOCs, file = "~/CO_CRA/CO_CRA/Output/acute_HIs_VOCs_95.csv")
```
...
write.csv(ozone_HQs, file = "~/CO_CRA/CO_CRA/Output/acute_ozone_HQs_95.csv")
```
