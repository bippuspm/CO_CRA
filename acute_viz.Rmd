...
## looking at the stacked bar for the hematological effects for the Northwest site to see what causes it to go above 1
...
#make stacked bar plot 
bar_hem95_phase = ggplot(HQ95_hem, aes(x = Phase, y = average_HQ, fill = Chemical)) +
  geom_bar(stat = "identity", position = "stack") +
  scale_fill_manual(values = chemical_colors, labels = chemical_labels) +  # Use custom labels for the legend
  theme_bw() +
  labs(x = "Phase", 
...
ggsave(filename = "bar_acuteHQ95_hema_phase_NW.png", device = "png", plot = bar_hem95_phase, path = "~/CO_CRA/CO_CRA/Output/", width = 7, height = 10)
