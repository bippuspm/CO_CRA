...
heat_HI50_VOCs = ggplot(HI50_VOCs, aes(x = Sampling.Site, y = Endpoint, fill = HI)) +
  ...
  theme_bw() +
  labs(title = "Chronic Hazard Indices - VOCs only (Median Chemical Conc.)",
       x = "Site",
       y = "Endpoint",
       fill = "HI") +
...
heat_HI95_VOCs = ggplot(HI95_VOCs, aes(x = Sampling.Site, y = Endpoint, fill = HI)) +
  ...
  scale_fill_gradientn(colors = brewer.pal(9, "YlGnBu")) +
  theme_bw() +
  labs(title = "Chronic Hazard Indices - VOCs only (95th Perc. Chemical Conc.)",
       x = "Site",
       y = "Endpoint",
       fill = "HI") +
    theme(axis.text.x = element_text(size = 14, angle = 45, hjust = 1),
...
heat_HI50 = ggplot(HI50, aes(x = Sampling.Site, y = Endpoint, fill = HI)) +
  ...
  scale_fill_gradientn(colors = brewer.pal(9, "YlGnBu")) +
  theme_bw() +
  labs(title = "Chronic Hazard Indices (Median Chemical Conc.)",
       x = "Site",
       y = "Endpoint",
       fill = "HI") +
    theme(axis.text.x = element_text(size = 14, angle = 45, hjust = 1),
...
heat_HI95 = ggplot(HI95, aes(x = Sampling.Site, y = Endpoint, fill = HI)) +
  ...
  scale_fill_gradientn(colors = brewer.pal(9, "YlGnBu")) +
  theme_bw() +
  labs(title = "Chronic Hazard Indices (95th Perc. Chemical Conc.)",
       x = "Site",
       y = "Endpoint",
       fill = "HI") +
    theme(axis.text.x = element_text(size = 14, angle = 45, hjust = 1),
...
bar_cancer50 = ggplot(cancer50, aes(x = Sampling.Site, y = Ind_Risk, fill = Chemical)) +
  ...
  labs(title = "Cancer Risk - Median Chemical Conc.", 
       x = "Site", 
       y = "Cancer Risk", 
       fill = "Chemical") +
  geom_hline(yintercept = 0.0001, linetype = "dashed") +
  geom_hline(yintercept = 0.000001, linetype = "dashed") +
  theme(axis.text.x = element_text(size = 14, angle = 45, hjust = 1),
        axis.text.y = element_text(size = 14),
        axis.title.x = element_text(size = 16),
        axis.title.y = element_text(size = 16),
