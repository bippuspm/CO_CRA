...
## code to add chronic heat maps together for MS correction
...
files <- c(
  "heat_chronicHI50.png",
  "heat_chronicHI95.png"
)
...
image_write(
  combined,
  path = "heat_chronic_bysite_combined.pdf",
  density = "300x300",
  format = "pdf"
)
...
image_write(
  combined,
  path = "heat_chronic_bysite_combined.tif",
  format = "tiff",
  density = "300x300",
  compression = "lzw"
)
...
image_write(
  combined,
  path = "heat_chronic_bysite_combined.png",
  format = "png"
)
```
